...
( () => {
    ...
    var r = {};
    e.r(r);
    var o, n = Object.defineProperty, t = Object.getOwnPropertySymbols, a = Object.prototype.hasOwnProperty, s = Object.prototype.propertyIsEnumerable, i = (e, r, o) => r in e ? n(e, r, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: o
    ...
    if (window === window.top || window.sdkLoaderWasInited) {
        ...
        window.YaGames = {
            init: o => {
                var d;
                return s ? null == (d = window.YaGames) ? void 0 : d.init(o) : i ? Promise.reject(v) : t ? (console.warn("YaGames was initialized"),
                t) : (t = new Promise( (t, s) => {
                    e = t,
                    r = s,
                    n = o,
        ...
        Object.defineProperty(window.YaGames, "deviceInfo", {
            get: () => (l("accessing deviceInfo in YaGames"),
            c)
        });
        const u = e => {
          ...
          , g = (o, t) => {
            ...
            d.onload = () => {
                var o;
                s = !0,
                a && (null == (o = window.YaGames) || o.init(n).then(r => {
                    e(r)
                }
                ).catch(e => {
        ...
        y ? h(y) : (o = function*() {
            return new Promise( (e, r) => {
                ...
                window.addEventListener("message", function r(t) {
                    ...
                    a && a.messageId === o && (window.removeEventListener("message", r),
                    clearTimeout(n),
                    e(a.payload))
                }),
